...
> {
  ...
  constructor(
    @inject('datasources.conexiongvsdb') dataSource: ConexiongvsdbDataSource, @repository.getter('PersonaRepository') protected personaRepositoryGetter: Getter<PersonaRepository>,
  ) {
